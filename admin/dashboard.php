                ...
                <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="thumb-sm avatar pull-left"> <img src="images/a0.png" alt="..." /> </span> John.Smith <b class="caret"></b>
                        </a>
                                        ...
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <span class="hidden-nav-xs clear">
                                                    <span class="block m-t-xs"> <strong class="font-bold text-lt">John.Smith</strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Art Director</span>
                                                </span>
                                            </a>
                                        ...
                                        <div class="row bg-light dk m-b">
                                            <div class="col-md-6 dker">
                                                <section>
                                                        ...
                                                        <div class="pull-right">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-select">
                                                                    <li>
                                                                        <a href="#"><input type="radio" name="b" />Month</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><input type="radio" name="b" />Week</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><input type="radio" name="b" />Day</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <div class="panel-body"><div id="flot-sp1ine" style="height: 210px;"></div></div>
                                                ...
                                                <section>
                                                    <header class="font-bold padder-v">
                                                        <div class="btn-group pull-right">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-select">
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Today</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Yesterday</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Last 24 Hours</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Last 7 Days</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Last 30 days</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />Last Month</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"><input type="radio" name="a" />All Time</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        Analysis
                                                    </header>
                                                    <div class="panel-body flot-legend"><div id="flot-pie-donut" style="height: 240px;"></div></div>
                                                </section>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <section class="panel b-a">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="m-b">
                                                            ...
                                                            <a href="#" class="avatar thumb-sm"> <img src="images/a3.png" alt="..." /> <i class="off b-white"></i> </a> <a href="#" class="btn btn-info btn-rounded font-bold"> +152 </a>
                                                        </div>
                                                    ...
                                                    <div class="clearfix panel-footer">
                                                        <small class="text-muted pull-right">5m ago</small> <a href="#" class="thumb-sm pull-left m-r"> <img src="images/a0.png" alt="..." class="img-circle" /> </a>
                                                        <div class="clear">
                                                ...
                                                <section class="panel b-a">
                                                    ...
                                                    <ul class="list-group list-group-lg no-bg auto">
                                                        <a href="#" class="list-group-item clearfix">
                                                            <span class="pull-left thumb-sm avatar m-r"> <img src="images/a4.png" alt="..." /> <i class="on b-white bottom"></i> </span>
                                                            <span class="clear"> <span>Chris Fox</span> <small class="text-muted clear text-ellipsis">What's up, buddy</small> </span>
                                                        </a>
                                                        <a href="#" class="list-group-item clearfix">
                                                            <span class="pull-left thumb-sm avatar m-r"> <img src="images/a5.png" alt="..." /> <i class="on b-white bottom"></i> </span>
                                                            <span class="clear"> <span>Amanda Conlan</span> <small class="text-muted clear text-ellipsis">Come online and we need talk about the plans that we have discussed</small> </span>
                                                        </a>
                                                        <a href="#" class="list-group-item clearfix">
                                                            <span class="pull-left thumb-sm avatar m-r"> <img src="images/a6.png" alt="..." /> <i class="busy b-white bottom"></i> </span>
                                                            <span class="clear"> <span>Dan Doorack</span> <small class="text-muted clear text-ellipsis">Hey, Some good news</small> </span>
                                                        </a>
                                                        <a href="#" class="list-group-item clearfix">
                                                            <span class="pull-left thumb-sm avatar m-r"> <img src="images/a7.png" alt="..." /> <i class="away b-white bottom"></i> </span>
                                                            <span class="clear"> <span>Lauren Taylor</span> <small class="text-muted clear text-ellipsis">Nice to talk with you.</small> </span>
                                                        </a>
                                                    </ul>
                                                    <div class="clearfix panel-footer">
                                                        <div class="input-group">
